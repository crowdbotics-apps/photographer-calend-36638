...
## Project Structure
    ...
    ├── photographer_calend_36638  # Django project configurations
...
1. Clone this repo and `cd photographer_calend_36638`
...
2. Clone this repo and `cd photographer_calend_36638`
